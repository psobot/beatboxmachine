...
qq.FileUploader = function (o) {
    ...
    qq.extend(this._options, {
        element: null,
        listElement: null,
        template: '<div class="qq-uploader">' + '<div class="qq-upload-drop-area"><span>'+window.wubconfig.drop_text+'</span></div>' + '<div class="qq-upload-button">'+window.wubconfig.upload_text+'</div>' + '<ul class="qq-upload-list"></ul>' + '</div>',
...
qq.extend(qq.UploadHandlerForm.prototype, {
    ...
    _getIframeContentJSON: function (iframe) {
        ...
        try {
            if ( typeof JSON != 'undefined' ) response = JSON.parse(doc.body.innerHTML);
            else response = eval("(" + doc.body.innerHTML + ")");
        } catch (err) {
            response = {};
        }
        return response;
